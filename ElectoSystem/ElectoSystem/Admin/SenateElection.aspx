<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Staff.Master" AutoEventWireup="true" CodeBehind="SenateElection.aspx.cs" Inherits="ElectoSystem.Admin.SenateElection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Configure Senate Election</h1>
    <div id="jsGrid"></div>
    <script>
        ...
        $NoConflict(function () {
            ...
            EndDateField.prototype = new jsGrid.Field({
                ...
                editTemplate: function (value) {
                    return this._editPicker = $NoConflict("<input>").datepicker({ changeMonth: true, changeYear: true, defaultDate: "", maxDate: "+12m +0w", minDate: "+0m +0w", yearRange: '<%= DateTime.Now.Year%>:<%= DateTime.Now.Year + 1%>', dateFormat: 'dd-mm-yy' });
                },
                insertValue: function () {
                    if (this._insertPicker.datepicker("getDate") != null) {
                        return this._insertPicker.datepicker("getDate").toISOString();
    ...
    <script type="text/javascript">
        function DeleteItem(item) {
            $.ajax({
                type: "POST",
                url: "SenateElection.aspx/DeleteItem",
        ...
        function AddItem(item) {
            $.ajax({
                type: "POST",
                url: "SenateElection.aspx/AddItem",
        ...
        function UpdateItem(item) {
            $.ajax({
                type: "POST",
                url: "SenateElection.aspx/UpdateItem",
        ...
        function OnSuccess(response) {
            Command: toastr["success"](response.d);
