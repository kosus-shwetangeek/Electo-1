...
{
    public partial class SenateElection : System.Web.UI.Page
    {
        public string JsonData
        {
            get
            {
                ...
                toEncode = studentHelper.GetAllSenateElectionsHelp();
        ...
        {
            UIHelper studentHelper = new UIHelper();
            if (studentHelper.AddUpdateDeleteSenateElectionHelp(Convert.ToInt32(id), DateTime.MinValue, DateTime.MinValue, "", "D"))
            {
                return "1";
        ...
        {
            UIHelper studentHelper = new UIHelper();
            if (studentHelper.AddUpdateDeleteSenateElectionHelp(0, Convert.ToDateTime(startdate), Convert.ToDateTime(enddate), description, "A"))
            {
                return "1";
        ...
        public static string UpdateItem(string id, string enddate)
        {
            ...
            if (studentHelper.AddUpdateDeleteSenateElectionHelp(Convert.ToInt32(id), DateTime.MinValue, Convert.ToDateTime(enddate), "", "E"))
            {
                return "1";
