<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Staff.Master" AutoEventWireup="true" CodeBehind="SenateNomination.aspx.cs" Inherits="ElectoSystem.Admin.SenateNomination" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="CenterTableHN">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DrpD_Designation" runat="server" AutoPostBack="False" Width="115px"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>&nbsp;
    ...
    <script>
        ...
        var SenateDropdownData = $NoConflict.parseJSON('<%= JSenateDesignationData%>');
    ...
    <script type="text/javascript">
        function DeleteNominee(item) {
            $.ajax({
                type: "POST",
                url: "SenateNomination.aspx/DeleteNominee",
                ...
                success: function (response) {
                    if (response.d == "1") {
                        ...
                        Command: toastr["error"]("Could not delete nominee...!!!");
                    }
                    else {
        ...
        function AddNominee(item) {
            $.ajax({
                type: "POST",
                url: "SenateNomination.aspx/AddNominee",
                data: '{xiClassSectionId: "' + item.Stud_ClassSectionId + '", xiStudKey: "' + item.Stud_Key + '", xiDesignationDrp: "' + $('select[id$=DrpD_Designation]').val() +'", xiElectionDrp: "' + $('select[id$=DrpD_Election]').val() +'"  }',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success:  function (response) {
                    if (response.d == "1") {
                        ...
                        Command: toastr["error"]("Could not add nominee...!!!");
                    }
                    else {
                        Command: toastr["warning"]("Could not complete operation. Please try later.");
                    }
