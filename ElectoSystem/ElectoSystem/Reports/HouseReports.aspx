<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Staff.Master" AutoEventWireup="true" CodeBehind="HouseReports.aspx.cs" Inherits="ElectoSystem.Reports.HouseReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="CenterTableHN">
        <tr>
            ...
            <td>
                <asp:DropDownList ID="Drp_House" AutoPostBack="true" OnSelectedIndexChanged="Drp_House_SelectedIndexChanged" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>&nbsp;
    ...
    <%if (StudHouseId > 0 && ReportElectionId > 0)
      {  %>
    <div class="chart-title"><%= StudHouseName %> Report</div>
    <%
    ...
    <script>
       ...
       <% var ChartDataList = lNomineeList.Select(o => new ElectoSystem.Common.PieChartData { Label = o.Nom_Name, Value = o.Nom_VoteCount.ToString(), Color = "#7e3838" });%>
