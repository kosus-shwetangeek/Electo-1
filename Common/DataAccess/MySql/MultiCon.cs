...
namespace Kosus.DataAccess.MySql
{
    ...
    /// </summary>
    public class MultiCon : XCon, IDisposable
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public int SendQuery(CommandType commandType, string query, params ParameterData[] parameterData)
        {
            using (MySqlConnection mysqlConnection = GetMysqlConnection())
            using (MySqlCommand mysqlCommand = mysqlConnection.CreateCommand())
                return base.SendQuery(mysqlCommand, commandType, query, parameterData);
        }
        ...
        /// <returns></returns>
        public DataTable GetDataTable(CommandType commandType,string query, params ParameterData[] parameterData)
        {
            using (MySqlConnection mysqlConnection = GetMysqlConnection())
            using (MySqlCommand mysqlCommand = mysqlConnection.CreateCommand())
                return base.GetDataTable(mysqlCommand,commandType,query,parameterData);
        }
